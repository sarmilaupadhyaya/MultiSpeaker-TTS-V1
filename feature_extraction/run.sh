...
python main.py  text_chevalier.txt fr 0 7
python main.py text_hugo.txt fr 0 8
python main.py text_sue.txt fr 0 9
python main.py text_tundra fr 0 10
python main.py text_zola fr 0 11
