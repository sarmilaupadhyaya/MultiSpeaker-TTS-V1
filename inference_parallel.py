...
outpath = '/home/ajkulkarni/workplace/subset2/Grad_TTS/parallel_v1'
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i, text in enumerate(texts):
            if os.path.exists(os.path.join(outpath,'sid+'+sids[i]+'_eid_'+eids[i]+'_'+fnames[i])) == False:
                ...
                write(os.path.join(outpath,'siwis_'+emotion_tag+'_'+fnames[i]), 22050, audio)
